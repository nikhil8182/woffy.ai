...
const milestones = [
  ...
  { number: '02', state: 'Next milestone', title: 'Bring the pieces together.', description: 'Develop an integrated prototype that connects the chosen hardware, control system, and interaction design.', work: 'Hardware configuration, controlled movement, and a working demonstration.', evidence: 'Documented limitations, repeatable behavior, and reliable human stop controls.' },
  { number: '03', state: 'After prototype validation', title: 'Learn through controlled use.', description: 'Evaluate the prototype with a small group in supervised environments and improve it through observation.', work: 'Participant feedback, reliability testing, and review of human controls.', evidence: 'A safety and reliability review, with changes informed by observed use.' },
