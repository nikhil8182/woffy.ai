...
const roadmapData = [
  {
    ...
    title: 'Research & Robot-Arm Learning',
    status: 'in-progress',
    icon: Brain,
    description: 'Training robot arms and exploring the connection between AI and physical actions.',
    gate: 'Next evidence: repeatable tasks with clear test conditions.',
    items: [
      'Robot-Arm Training Experiments',
      'Learning from Demonstrations',
      'Observe and Evaluate Physical Tasks',
      'Explore Woffy Interaction Concepts'
    ]
  },
  {
    id: 'phase-2',
    ...
    status: 'upcoming',
    icon: Zap,
    description: 'Bring the chosen hardware, controls, and interaction design together.',
    gate: 'Gate: a working demonstration with documented limits and human stop controls.',
    items: [
  ...
  {
    id: 'phase-3',
    period: 'After prototype validation',
    title: 'Controlled Pilot',
    status: 'upcoming',
    icon: Rocket,
    description: 'Evaluate the prototype in supervised settings and learn from real use.',
    gate: 'Gate: participant feedback and a review of safety and reliability.',
    items: [
      'Plan Supervised Testing',
      'Collect Participant Feedback',
      'Review Reliability and Human Controls',
      'Improve the Product Design'
    ]
  },
  {
    id: 'phase-4',
    period: 'After pilot validation',
    title: 'Launch Readiness',
    status: 'upcoming',
    icon: Globe,
    description: 'Confirm manufacturing, support, and required certifications before release.',
    gate: 'Gate: verified specifications, clear pricing, and a confirmed availability plan.',
    items: [
      'Confirm Production Configuration',
      'Verify Required Certifications',
      'Prepare Service and Support',
      ...
      <div className={`ml-16 md:ml-0 md:w-1/2 ${isEven ? 'md:pr-20' : 'md:pl-20'}`}>
        ...
        >
          ...
          <div className="relative bg-slate-950/90 backdrop-blur-xl rounded-[22px] p-6 md:p-8 h-full border border-white/5 hover:border-white/10 transition-colors">
            ...
            {isInProgress && (
              <div className="mb-6 rounded-xl border border-brand-rose/20 bg-brand-rose/5 p-3 text-sm text-slate-300">
                Current focus. Progress is reported through demonstrated results.
              </div>
            )}
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-400 max-w-2xl mx-auto leading-relaxed mb-12">
              Our development path, updated 6 September 2026. We are in research and development. Future steps depend on testing; no launch date is confirmed.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 backdrop-blur-sm">
              ...
              <p className="text-slate-400">Exploring AI models that connect perception with physical action.</p>
            </div>
            <div className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 backdrop-blur-sm">
              ...
              <p className="text-slate-400">Testing responsiveness and clear controls before setting performance targets.</p>
            </div>
            <div className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 backdrop-blur-sm">
              ...
              <p className="text-slate-400">Exploring the infrastructure a future connected product will need.</p>
            </div>
          </div>
        </div>
      </section>
