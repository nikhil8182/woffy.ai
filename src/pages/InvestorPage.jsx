    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-600 leading-relaxed mb-8">
              A companion robotics concept from Onwords. We are training robot arms and exploring useful, friendly AI for the physical world.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-7xl font-bold mb-2 tracking-tighter">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-amber-400">Robotics</span>
                </h3>
                <p className="text-2xl font-light text-slate-300 mb-8">Research & Development</p>
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="text-slate-400 text-sm">Physical Interaction</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold mb-1">Home</div>
                    <div className="text-slate-400 text-sm">Everyday Use</div>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
               ...
               >
                 ...
                 <div className="text-4xl font-bold text-slate-900 mb-2">R&amp;D</div>
                 <div className="text-slate-600 font-medium">Current Stage</div>
                 <div className="text-rose-500 text-xs font-bold mt-2 uppercase tracking-wide">Building and learning</div>
               </motion.div>
               ...
               >
                 ...
                 <div className="text-4xl font-bold text-slate-900 mb-2">Train</div>
                 <div className="text-slate-600 font-medium">Robot Arms</div>
                 <div className="text-indigo-500 text-xs font-bold mt-2 uppercase tracking-wide">Current work</div>
               </motion.div>
               ...
               >
                 ...
                 <div className="text-4xl font-bold text-slate-900 mb-2">Test</div>
                 <div className="text-slate-600 font-medium">Physical Tasks</div>
                 <div className="text-amber-500 text-xs font-bold mt-2 uppercase tracking-wide">Learn from results</div>
               </motion.div>
               ...
               >
                 ...
                 <div className="text-4xl font-bold text-slate-900 mb-2">Build</div>
                 <div className="text-slate-600 font-medium">Human Interaction</div>
                 <div className="text-purple-500 text-xs font-bold mt-2 uppercase tracking-wide">Long-term direction</div>
               </motion.div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Our design direction brings together robotics, expressive interaction, and home integration. These are research goals, not finished product features.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[minmax(180px,auto)]">
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-slate-900 mb-4">AI Learning Research</h3>
                  <p className="text-lg text-slate-600 leading-relaxed mb-6">
                    We are training robot arms and exploring how AI can connect perception with physical actions. <strong>Learning and context</strong> remain areas to investigate for the Woffy concept.
                  </p>
                </div>

                <div className="flex gap-3 flex-wrap">
                  <span className="px-3 py-1 rounded-lg bg-slate-100 text-slate-600 text-sm font-medium">Context Research</span>
                  <span className="px-3 py-1 rounded-lg bg-slate-100 text-slate-600 text-sm font-medium">Expression Concepts</span>
                  <span className="px-3 py-1 rounded-lg bg-slate-100 text-slate-600 text-sm font-medium">Learning Experiments</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Home Integration Concept</h3>
                <p className="text-slate-400 mb-8 flex-grow">
                  We are exploring how a future Woffy could connect with <strong>everyday home routines</strong>. Device compatibility, controls, and availability are not yet confirmed.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-slate-300">
                    <div className="w-2 h-2 rounded-full bg-green-500"></div>
                    <span className="text-sm">Local Processing Goal</span>
                  </div>
                  <div className="flex items-center gap-3 text-slate-300">
                    <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                    <span className="text-sm">Compatibility Research</span>
                  </div>
                  <div className="flex items-center gap-3 text-slate-300">
                    <div className="w-2 h-2 rounded-full bg-purple-500"></div>
                    <span className="text-sm">Room-Aware Concept</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">Patrol Concept</h3>
              <p className="text-sm text-slate-600">
                Exploring useful awareness of the home. This is a proposed capability, not a security service.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-slate-600">
                A concept for expressive eyes and a friendly character. Display hardware is not yet confirmed.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4 mb-3">
                ...
                <h3 className="text-lg font-bold text-slate-900">Local-First Design Goal</h3>
              </div>
              <p className="text-slate-700 text-sm leading-relaxed">
                We aim to keep appropriate controls close to the device. Offline behavior, data handling, and response time will be defined and tested as the hardware develops.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-700 text-sm leading-relaxed">
                Exploring two character directions: <strong>Cloud</strong> for gentle indoor companionship and <strong>Titan</strong> for utility and exploration. Neither is a confirmed production model.
              </p>
            </motion.div>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto font-light">
              Two design concepts to explore different forms of companionship.
            </p>
          </motion.div>
              ...
              <div className="relative h-full bg-slate-950/90 backdrop-blur-3xl rounded-[2.5rem] p-10 border border-white/10 overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex-grow">
                  ...
                  <div className="space-y-6 mb-12">
                     {[
                        { icon: "🧸", text: "Soft-Touch Concept", sub: "Materials to be confirmed" },
                        { icon: "🏠", text: "Indoor Companion", sub: "Proposed home-focused design" },
                        { icon: "❤️", text: "Gentle Interaction", sub: "Exploring expressive behavior" },
                        { icon: "👶", text: "People First", sub: "Safety requires validation" }
                     ].map((item, idx) => (
            ...
            >
              ...
              <div className="relative h-full bg-slate-950/90 backdrop-blur-3xl rounded-[2.5rem] p-10 border border-white/10 overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex-grow">
                  ...
                  <div className="space-y-6 mb-12">
                     {[
                        { icon: "🛡️", text: "Durable Shell Concept", sub: "Materials require testing" },
                        { icon: "🌍", text: "Exploration Concept", sub: "Environment suitability unconfirmed" },
                        { icon: "🚀", text: "Navigation Research", sub: "Mapping and patrol are proposed" },
                        { icon: "💻", text: "Builder Focus", sub: "Exploring programmable interfaces" }
                     ].map((item, idx) => (
                        <div key={idx} className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/5 transition-colors">
                           <div className="text-2xl">{item.icon}</div>
                           <div>
      ...
      <section className="py-24 px-6 relative overflow-hidden bg-slate-50">
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Costs, pricing, production volumes, and margins are not confirmed. Each stage needs a validated design and current supplier estimates.
            </p>
          </motion.div>
              ...
              {[
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-slate-200 flex flex-wrap gap-2 justify-between items-center">
                      <span className="text-slate-500 font-medium">Product Price</span>
                      <span className="text-lg font-bold text-slate-900">{tier.mrp}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-8 relative z-10 flex items-center gap-3">
                <span className="p-2 bg-white/10 rounded-lg">💰</span> Potential Revenue Streams
              </h3>

              <div className="grid sm:grid-cols-2 gap-4 relative z-10">
                {[
                  { title: "Hardware Sales", desc: "Model under consideration", icon: "📦" },
                  { title: "AI Subscription", desc: "Not yet confirmed", icon: "🧠" },
                  { title: "Cloud Storage", desc: "Not yet confirmed", icon: "☁️" },
                  { title: "Accessories", desc: "Concept accessories", icon: "🎒" },
                  { title: "AMC Services", desc: "Support plan to be defined", icon: "🔧" }
                ].map((item, i) => (
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">Design Context</p>
                  </div>
                </div>
                      ...
                      <div className="flex-grow">
                        <div className="flex flex-wrap gap-3 justify-between items-start mb-3">
                          ...
                          <div className="text-right">
                            <div className="text-slate-400 font-mono text-sm font-bold">Varies</div>
                            <div className="text-xs text-slate-400 mt-0.5">By product</div>
                          </div>
                        </div>
                        <div className="w-full bg-slate-50 rounded-xl h-12 flex items-center px-4 border border-slate-100 relative overflow-hidden">

                          <span className="text-xs text-slate-500 font-semibold relative z-10">Capabilities vary by product</span>
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          <div className="flex flex-wrap gap-3 justify-between items-start mb-3">
                            <div>
                              <div className="flex flex-wrap items-center gap-2 mb-1">
                                ...
                                <span className="px-2 py-0.5 rounded-md bg-indigo-100 text-indigo-700 text-xs font-bold uppercase tracking-wider">IN RESEARCH</span>
                              </div>
                              <div className="text-xs text-indigo-600 font-semibold">Companion robotics • Design direction</div>
                            </div>
                            <div className="text-right">
                              <div className="text-slate-900 font-mono text-xl font-bold">Unconfirmed</div>
                              <div className="text-xs text-slate-600 mt-0.5 font-medium">Pricing</div>
                            </div>
                          </div>
                          ...
                          <div className="w-full bg-white rounded-xl h-16 flex items-center px-1 relative overflow-hidden shadow-inner border border-indigo-100">
                            ...
                            <div className="w-full flex justify-between px-4 relative z-10">
                              <div className="text-center">
                                <div className="text-xs font-bold text-indigo-700 uppercase tracking-wider mb-1">Learning</div>
                                <div className="text-xs text-slate-600">Robot-arm research</div>
                              </div>
                              <div className="w-px bg-indigo-200"></div>
                              <div className="text-center">
                                <div className="text-xs font-bold text-indigo-700 uppercase tracking-wider mb-1">Exploring</div>
                                <div className="text-xs text-slate-600">Product configuration</div>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-grow">
                        ...
                        <div className="w-full bg-slate-50 rounded-xl h-12 flex items-center px-4 border border-slate-100 relative overflow-hidden">
                          ...
                          <span className="text-xs text-slate-500 font-semibold relative z-10">Capabilities and pricing vary by model</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-600 leading-relaxed">
                        Woffy is exploring <span className="font-bold text-indigo-700">friendly robotics for the home</span>. The product configuration, capabilities, and pricing will depend on validated research and development.
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Built by Onwords</h2>
            <a
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 md:p-12 text-white">
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-rose-400 mb-2">Homes</div>
                <div className="text-slate-300">Smart Home Experience</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-purple-400 mb-2">Gates</div>
                <div className="text-slate-300">Gate Automations</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-400 mb-2">AI</div>
                <div className="text-slate-300">Ongoing Experiments</div>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-slate-50 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Capital Planning Areas</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              The work ahead spans engineering, production planning, and validation. Funding requirements and allocations will be confirmed as the product takes shape.
            </p>
          </motion.div>
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="bg-white rounded-[2.5rem] p-8 shadow-xl border border-slate-100 relative overflow-hidden">
                ...
                <div className="space-y-6 relative z-10">
                  {[
                    { label: 'Product Development', stage: 'Research', color: 'bg-rose-500', icon: '🛠️', desc: 'Engineering, AI training, & Prototyping' },
                    { label: 'Tooling & Production', stage: 'Planned', color: 'bg-indigo-500', icon: '🏭', desc: 'Molds, Assembly Setup, & Supply Chain' },
                    { label: 'Certifications', stage: 'To assess', color: 'bg-amber-500', icon: '📜', desc: 'Identify applicable requirements and validation' },
                    { label: 'Marketing & Launch', stage: 'Future', color: 'bg-emerald-500', icon: '🚀', desc: 'GTM Strategy, PR, & Brand Awareness' },
                  ].map((item, idx) => (
                    <motion.div
                      key={idx}
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <div className="flex justify-between items-end mb-2">
                        ...
                        <span className="text-slate-600 font-mono font-bold text-sm">{item.stage}</span>
                      </div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2 relative z-10">
                  <span className="text-amber-400">⚡</span> Cost Areas to Validate
                </h3>

                <div className="space-y-4 relative z-10">
                  {[
                    { label: 'Injection Mold Tooling', range: 'Unconfirmed' },
                    { label: 'Custom PCB Design', range: 'Unconfirmed' },
                    { label: 'Required Certifications', range: 'Unconfirmed' },
                    { label: 'Software & IP', range: 'Unconfirmed' },
                  ].map((item, idx) => (
                ...
                <div className="mt-8 pt-6 border-t border-white/10 flex justify-between items-end">
                  <span className="text-slate-400 text-sm font-medium uppercase tracking-wider">Funding Requirement</span>
                  <div className="text-right">
                    <span className="block text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-yellow-500">
                      To be confirmed
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div>
                   <h4 className="font-bold text-slate-900 text-sm mb-1">Evidence Before Estimates</h4>
                   <p className="text-xs text-slate-600 leading-relaxed">
                     Production costs and margins need <span className="font-bold text-emerald-700">current supplier estimates</span> and a validated design.
                   </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-900 to-indigo-950 backdrop-blur-3xl rounded-[3rem] p-12 md:p-24 border border-indigo-500/20 shadow-[0_0_100px_-20px_rgba(79,70,229,0.2)] relative overflow-hidden group">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-xl md:text-2xl text-slate-300 mb-14 max-w-3xl mx-auto leading-relaxed font-light">
                  We welcome conversations with robotics builders, hardware partners, and investors.
                  <span className="block mt-2 text-white font-medium">Tell us what you are building and where we could work together.</span>
                </p>

                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
                  <motion.a
                    href="mailto:hello@woffy.ai?subject=Woffy%20project%20overview"
                  ...
                  >
                    <span className="relative z-10">Request Project Overview</span>
                ...
                <div className="pt-10 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                  <div className="flex flex-col items-center md:items-start">
                    ...
                    <a href="mailto:hello@woffy.ai" className="text-2xl font-bold text-white hover:text-indigo-300 transition-colors tracking-tight">hello@woffy.ai</a>
                  </div>
                  ...
                  <div className="flex flex-col items-center md:items-end">
                     <span className="text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Based in India</span>
                     <span className="text-slate-200 font-medium text-lg">Coimbatore</span>
                  </div>
                </div>
              </div>
            </div>
