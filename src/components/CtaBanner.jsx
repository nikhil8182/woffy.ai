...
const CtaBanner = () => {
  return (
    <section className="py-24 bg-red-600 relative overflow-hidden">
        {/* Decorative circles */}
        <div className="absolute top-0 left-0 -ml-20 -mt-20 w-64 h-64 bg-red-500 rounded-full opacity-50"></div>
        <div className="absolute bottom-0 right-0 -mr-20 -mb-20 w-64 h-64 bg-red-700 rounded-full opacity-50"></div>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 text-white">
        <div className="inline-block bg-red-800/30 px-4 py-1 rounded-full text-sm font-medium mb-6 border border-red-400/30">
