          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              ...
              <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Get occasional development updates and future pilot news as we build Woffy. Joining the list does not reserve a product.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-slate-400 text-sm">A design priority</div>
                  </div>
                </div>
                ...
                <div className="pt-2">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-brand-rose text-sm font-bold">Prototype</span>
                  </div>
                  <div className="w-full h-2 bg-slate-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-brand-rose to-brand-indigo w-full opacity-40 rounded-full"></div>
                  </div>
                </div>
              </div>
            </div>
