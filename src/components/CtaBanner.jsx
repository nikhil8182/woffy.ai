...
const CtaBanner = ({ onJoinWaitlist }) => {
  return (
    <section className="py-24 bg-rose-600 relative overflow-hidden">
        {/* Decorative circles */}
        <div className="absolute top-0 left-0 -ml-20 -mt-20 w-64 h-64 bg-rose-500 rounded-full opacity-50"></div>
        <div className="absolute bottom-0 right-0 -mr-20 -mb-20 w-64 h-64 bg-rose-700 rounded-full opacity-50"></div>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 text-white">
        <div className="inline-block bg-rose-800/30 px-4 py-1 rounded-full text-sm font-medium mb-6 border border-rose-400/30">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <button 
            ...
            className="px-8 py-4 bg-white text-rose-600 rounded-full font-bold text-lg hover:bg-rose-50 transition-colors shadow-lg"
          >
            Join the Waitlist
          </button>
          <a 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-rose-500/50 pt-8 text-rose-100">
          <div>
