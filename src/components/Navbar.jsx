...
const Navbar = ({ onJoinWaitlist, themeMode }) => {
  ...
  const isDark = themeMode === 'titan' || isSpecs || location.pathname === '/chat';
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-500 ${
      ...
      {isMobileMenuOpen && (
        <div id="mobile-navigation" className={`md:hidden absolute w-full left-0 top-full ${isDark ? 'bg-slate-950/95 border-b border-white/10' : 'bg-white/95 border-b border-gray-100'} backdrop-blur-xl transition-all duration-300 ease-in-out`}>
