      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)]">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 leading-relaxed text-lg">
                            We are exploring local processing for responsive interactions and privacy. The hardware, offline capabilities, and data handling will be confirmed through testing.
                        </p>
                    </div>
                </div>
            </motion.div>
                ...
                <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="mt-auto">
                        ...
                        <p className="text-slate-300 leading-relaxed mb-8">
                            Our motion concept explores expressive quadruped movement. Dancing, stretching, and obstacle navigation remain development goals.
                        </p>
            ...
            >
                ...
                <p className="text-slate-600 text-sm leading-relaxed">Expressive screen eyes are part of the interaction concept, with expressions to be developed through testing.</p>
            </motion.div>
            ...
            >
                ...
                <p className="text-slate-600 text-sm leading-relaxed">Aiming for a robot that manages its energy and returns to a charging pad. Still a design goal.</p>
            </motion.div>
