...
const TwoPersonalities = ({ onToggleTheme, currentTheme }) => {
  ...
  return (
    <section className="py-16 md:py-32 bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0  opacity-[0.03] z-0"></div>
            ...
            <div className="relative z-10 flex flex-col h-full min-h-[320px]">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                   ...
                   <span className="px-3 py-1 bg-white/10 rounded-lg text-sm text-white/90 backdrop-blur-sm">Companionship</span>
                </div>
              </div>
            </div>
