      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className={`text-xl leading-relaxed transition-colors duration-500 ${
            ...
            Our vision is a companion that can help with everyday home routines.
            <span className="font-semibold block mt-2">Exploring local control and useful home routines.</span>
          </p>
        </div>
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <div className="mt-auto flex items-center justify-center">
                    <div className={`text-center ${
                      ...
                      <div className="text-xs uppercase font-bold tracking-widest mb-2">Preview</div>
