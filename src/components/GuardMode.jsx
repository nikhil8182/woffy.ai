          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <p className="text-xl text-slate-400 mb-10 leading-relaxed font-light border-l border-slate-800 pl-6">
                Our longer-term vision is a companion that can help notice changes at home and send <span className="text-white font-medium">useful alerts</span> instantly.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Exploring recognition of people and pets. Accuracy and on-device processing are not yet verified."
                  },
                  {
                    icon: AlertTriangle,
                    title: "Active Deterrence System",
                    desc: "A proposed integration with home alerts, subject to testing and user control."
                  },
                  {
                    icon: Lock,
                    title: "Physical Privacy Shutters",
                    desc: "A physical camera disconnect is a design goal. Hardware and data handling remain to be confirmed."
                  }
                ].map((item, idx) => (
                  <motion.div
                    key={idx}
